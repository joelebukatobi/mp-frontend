...
export default function Navbar() {
  return (
    <nav className="container h-[8.8rem] mx-auto w-full mt-[4rem] px-[3.2rem] md:px-[4rem] lg:px-[7.2rem]">
      <div className="w-full justify-between items-center pb-[2.4rem] md:border-b-[.15rem] border-black md:flex">
        <Link href="/">
          <svg className="h-[2.4rem] fill-black cursor-pointer" viewBox="0 0 129 17">
            <use href="/images/sprite.svg#logo" />
          </svg>
        </Link>
        <ul className="hidden md:flex space-x-[6.4rem]">
          <Link href="/">
